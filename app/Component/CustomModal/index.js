          ...
          >
            <div className="flex flex-col w-[80%] sm:w-[70%] ">
              ...
              <input
                ref={input}
                type="text"
                className="border-[#E2E8F0]   px-4 py-3 rounded-lg border-[1.5px] border-solid bg-white w-full outline-none placeholder:text-[#94A3B8] text-white text-sm leading-[22px] tracking-[0.14px] mt-[6px]"
